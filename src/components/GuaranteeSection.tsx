  ...
  return (
    <section className="relative min-h-screen py-20 lg:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-black">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        {/* Services Breakdown Video */}
        <div className="mt-24 lg:mt-32 max-w-6xl mx-auto">
          <div className="text-center mb-10 md:mb-12">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 md:mb-6">
              Here's a Further Breakdown of the Services We Provide
            </h2>
          </div>
            ...
            <div className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-black border-2 border-green-500/20 rounded-2xl sm:rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(34,197,94,0.15),0_20px_60px_rgba(0,0,0,0.8)] group-hover:shadow-[0_0_80px_rgba(34,197,94,0.25),0_25px_70px_rgba(0,0,0,0.9)] transition-all duration-500">
              ...
              <div className="aspect-video w-full relative">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/95HErntFo0M"
                  title="DineAuto Services Breakdown"
